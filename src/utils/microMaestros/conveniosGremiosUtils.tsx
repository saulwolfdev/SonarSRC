...
import { fetchConvenios } from "@/services/microMaestros/conveniosGremiosService";
import { ConveniosFiltradasRequest, ConveniosFiltradasResponse } from "@/types/microMaestros/convenioGremioTypes";
...
export const buscarConvenios = (
  ...
  fetchConvenios({codigoAsociacionGremial: Number(codigoAsociacionGremial), ... filtros})
