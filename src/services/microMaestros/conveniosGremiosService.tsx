...
import { ConvenioByIdRequest, ConvenioCreate, ConvenioDetalleResponce, ConveniosFiltradasRequest, ConveniosFiltradasResponse, ConvenioUpdate } from "@/types/microMaestros/convenioGremioTypes";
...
export const putConvenio = async (body: ConvenioUpdate) => {
  const res = await axiosMaestros.put("/gremios/convenios-colectivos ", body);
  return res;
};
