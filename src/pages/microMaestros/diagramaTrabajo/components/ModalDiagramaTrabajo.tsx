...
import { DiagramaTrabajoFiltradoRequest } from "../types/diagramaTrabajoTypes";
import { fetchDiagramaTrabajo } from "../services/DiagramaTrabajoService";
...
const ModalDiagramaTrabajo: React.FC<ModalEstadoProps> = ({
  open,
  handleClose,
  id,
  toggleActivation,
  ...
  const buscarFuncEstId = async () => {
    ...
    const response = await fetchDiagramaTrabajo(filtrosAplicados)   
      ...
      >
        ...
        >
          <Typography id="modal-title" variant="h1">
            {isActivated ? "Desactivar" : "Activar"} diagrama trabajo
          </Typography>
...
export default ModalDiagramaTrabajo;
