...
import { NameGridData } from "@/types/microMaestros/funcionEstandarizadaTypes"
...
interface GridFuncionEstandarizadaProps {
...
const GridFuncionEstandarizada = ({
  clasificaciones,
  pagination,
  handleModalOpenEstado,
  exportButton,
  handleApplySort,
}: GridFuncionEstandarizadaProps) => {
  ...
  const handleNavigation = (id: number, nombre: string) => {
    routerPushQuery({
      pathname: "/microMaestros/funcionEstandarizada/editar",
      query: { id, nombre },
    })
  }
...
export default GridFuncionEstandarizada
