...
import { fetchTipoLicenciasProlongadasById } from "../../../../services/microMaestros/tipoLicenciasProlongadasService";
...
const ModalEstado: React.FC<ModalEstadoProps> = ({
  ...
  const buscarClasificacionId = async () => {
    const response = await fetchTipoLicenciasProlongadasById(id)
