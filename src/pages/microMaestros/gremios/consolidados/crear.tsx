...
import { InputsCreateUpdate } from "@/components/microMaestros/gremios/consolidados/formCreateUpdate/InputCreateUpdate";
import ButtonsCreateUpdate from "@/components/shared/ButtonsCreateUpdate";
import ArrowbackButton from "@/components/shared/ArrowbackButton";
import { postGremioConsolidado } from "@/services/microMaestros/consolidadosService";
...
export default function CrearGremioConsolidado() {
  ...
  const codigoGremioConsolidador = useCodigosStore((state) => state.codigoGremioConsolidador)
  ...
  const formik = useFormik({
    initialValues: {
      codigoGremioConsolidador: Number(codigoGremioConsolidador),
      nombre: "",
      estado: true,
    },
    validationSchema: validationSchema,
    onSubmit: (values) => {
      postGremioConsolidado(values)
        .then((res) => {
