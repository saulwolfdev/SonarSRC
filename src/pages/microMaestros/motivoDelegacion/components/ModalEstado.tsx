...
import { fetchMotivoDelegacionById } from "../../../../services/microMaestros/motivoDelegacionService";
...
const ModalEstado: React.FC<ModalEstadoProps> = ({
  ...
  const buscarClasificacionId =async () => {
    const response = await fetchMotivoDelegacionById(id)
    setclasificacionNombre(response.nombreMotivo)
