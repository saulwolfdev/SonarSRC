...
import { CategoriasMonotributoFiltradoRequest } from "../types/CategoriasMonotributoTypes";
import { fetchCategoriasMonotributo } from "../services/CategoriasMonotributoService";
...
const ModalCategoriasMonotributo: React.FC<ModalEstadoProps> = ({
  open,
  handleClose,
  id,
  toggleActivation,
  ...
  const buscarFuncEstId = async () => {
    ...
    const response = await fetchCategoriasMonotributo(filtrosAplicados)
...
export default ModalCategoriasMonotributo;
