...
import { getSerchParams } from "@/utils/microMaestros/conveniosColectivosUtils"
import { exportConvenios } from "@/services/microMaestros/conveniosColectivoService"
...
const goToDetalles = (id: number, nombre: string) =>{
  routerPush(`/microMaestros/convenios/detalles`)
...
label="Ver detalle"
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: "asociacionesGremiales",
      headerName: "Asociacones gremiales",
      flex: 1,
      minWidth: 80,
      maxWidth: 250,
    },
