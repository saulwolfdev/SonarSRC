...
import { downloadPlantillaContratistaEditarMasiva } from "@/services/microContratos/contratistasService";
import { typeAlert } from "@/components/shared/SnackbarAlert";

interface DragAndDropContratistaProps {
  setFile: any;
  setAlertMessage: any;
  setAlertType: any;
...
export default function DragAndDropContratista({
  setFile,
  setAlertMessage,
  setAlertType,
  handleFileChangeInput,
  isUploading,
}: DragAndDropContratistaProps) {
  ...
  const handleDownloadClick = async () => {
    await downloadPlantillaContratistaEditarMasiva(setAlertMessage, setAlertType);
  };
